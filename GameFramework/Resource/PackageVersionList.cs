...
namespace GameFramework.Resource
{
    ...
    public partial struct PackageVersionList
    {
        ...
        public PackageVersionList(string applicableGameVersion, int internalResourceVersion, Asset[] assets, Resource[] resources, Binary[] binaries, ResourceGroup[] resourceGroups)
        {
            m_IsValid = true;
