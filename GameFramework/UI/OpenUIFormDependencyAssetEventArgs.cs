...
namespace GameFramework.UI
{
    ...
    public sealed class OpenUIFormDependencyAssetEventArgs : GameFrameworkEventArgs
    {
        ...
        public OpenUIFormDependencyAssetEventArgs(int uiFormTypeId, string uiFormAssetName, string uiGroupName, bool pauseCoveredUIForm, string dependencyAssetName, int loadedCount, int totalCount, object userData)
        {
